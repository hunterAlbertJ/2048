...
public class Board {
    ...
    private final BufferedImage updatedBoard;
    private final int x;
    private final int y;
    ...
    private final Font displayFont = new Font("American Typewriter", Font.PLAIN, 26);
    ...
    private void resetPosition(Tile current, int row, int col) {
        ...
        // continues to set the Tile position until Tile has moved entire distance
    ...
    // ACCESSOR METHODS
    /*
     * Sends user win pop-up message after they have beaten the game
     */
